...
export default function Features() {
  return (
    <div className="flex min-h-screen flex-col items-center p-24">      <h2 className="text-4xl font-bold text-center mb-32">
      ...
      <section className="mb-32">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          </div>          <div className="relative h-72 w-full">
            <Image
              src="/window.svg"
      ...
      <section className="mb-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">          <div className="relative h-72 w-full order-2 md:order-1">
            <Image
              src="/globe.svg"

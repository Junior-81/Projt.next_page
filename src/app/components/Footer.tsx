  ...
  return (    <footer className="bg-gray-100">
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="flex justify-center gap-6 mb-8">
          <a href="https://github.com/Junior-81" className="text-gray-400 hover:text-gray-600 transition-colors" target="_blank" rel="noopener noreferrer">
        ...
        <div className="text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} Nextjs Starter. Desenvolvido por <a href="https://github.com/Junior-81" className="text-[#00A3FF] hover:text-[#0081CC] transition-colors" target="_blank" rel="noopener noreferrer">Ailton Junior</a></p>
        </div>
      </div>
    </footer>
  )
